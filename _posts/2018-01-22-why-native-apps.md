...
<script type="application/ld+json">
{
  ...
  "@type" : "Article",
  "name" : "Why Native Apps Are Better Than Web Apps",
  "headline" : "Why Native Apps Are Better Than Web Apps",
  "author" : {
    "@type" : "Person",
    "name" : "Grant Hull"
  },
  "datePublished" : "2018-01-22",
  "image" : "http://blog.enabled.com.au/images/img_native_icat.jpg",
  "articleSection" : [ "How Apps came about", "What are the development options on mobile?", "Why build native apps?", "Other advantages of native apps over web apps (or language)", "In summary" ],
  "publisher" : {
    "@type" : "Organization",
    "name" : "Enabled",
    "logo": {
...
"description": "Learn the definitions & differences between native vs hybrid vs web apps vs websites. Native apps built true to the mobile platform are better. Here’s why."
}
</script>
