...
<script type="application/ld+json">
{
  ...
  "@type" : "Article",
  "name" : "Can You Mix and Match Your Way to a Platform Business Model?",
  "headline" : "Can You Mix and Match Your Way to a Platform Business Model?",
  "author" : {
    "@type" : "Person",
    "name" : "Linh Dao"
  },
  "datePublished" : "2016-07-07",
  "image" : "http://blog.enabled.com.au/images/img_platform_pipe.png",
  "articleSection" : [ "A primer on platforms", "Different platform flavours", "Determining the suitable flavours" ],
  "publisher" : {
    "@type" : "Organization",
    "name" : "Enabled",
    "logo": {
...
"description": "The success of platforms such as Airbnb & Uber has sparked a new business model boom. Let’s discuss different platform flavours and other crucial factors."
}
</script>
