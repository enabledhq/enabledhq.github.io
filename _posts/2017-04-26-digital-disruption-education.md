...
<script type="application/ld+json">
{
  ...
  "@type" : "Article",
  "name" : "What You Can Learn from Universities’ Response to Digital Disruption",
  "headline" : "What You Can Learn from Universities’ Response to Digital Disruption",
  "author" : {
    "@type" : "Person",
    "name" : "Grant Hull"
  },
  "datePublished" : "2017-05-05",
  "image" : "http://blog.enabled.com.au/images/img_edudisrupt.gif",
  "articleSection" : [ "Education disrupted", "How self-disruption becomes the answer to disruption", "What are Australian universities doing to combat disruption?", "No one can afford to do nothing" ],
  "publisher" : {
    "@type" : "Organization",
    "name" : "Enabled",
    "logo": {
...
"description": "Digital disruption is coming to education. How universities fight back: an Adelaide uni joins force with a MOOC provider & what you can learn."
}
</script>
