...
<script type="application/ld+json">
{
  ...
  "@type" : "Article",
  "name" : "10 Plus 1 Commandments for the Modern Mobile App Designer",
  "headline" : "10 Plus 1 Commandments for the Modern Mobile App Designer",
  "author" : {
    "@type" : "Person",
    "name" : "Simeon Saens"
  },
  "datePublished" : "2017-09-22",
  "image" : "http://blog.enabled.com.au/images/Blog_Header_appdesign.png",
  "articleSection" : [ "Don’t hide features behind gestures", "Get rid of features", "Don’t use hamburger menus", "Support accessibility", "Use animation to be helpful", "Avoid lengthy in-app copy", "Avoid pop-ups unless absolutely necessary", "Don’t use “Bug fixes and performance improvements” in your release notes, ever", "Be smart about user feedback", "Be smart about user testing", "Build to the platform", "Final words" ],
  "publisher" : {
    "@type" : "Organization",
    "name" : "Enabled",
    "logo": {
...
"description": "It’s easy to forget who you’re designing the app for. Here’re some simple & actionable tips for the modern app designer to improve mobile app UX and UI."
}
</script>
