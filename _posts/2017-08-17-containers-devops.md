...
<script type="application/ld+json">
{
  ...
  "@type" : "Article",
  "name" : "Containers in DevOps: Options & Best Practices in Security",
  "headline" : "Containers in DevOps: Options & Best Practices in Security",
  "author" : {
    "@type" : "Person",
    "name" : "Dylan Sale"
  },
  "datePublished" : "2017-08-17",
  "image" : "http://blog.enabled.com.au/images/blog_header_devops.jpg",
  "articleSection" : [ "What’s DevOps anyway?", "Containers: definition and benefits", "What options are there for containers?", "What are the best practices to secure containers?" ],
  "publisher" : {
    "@type" : "Organization",
    "name" : "Enabled",
    "logo": {
...
"description": "Docker as a tool for containerisation is quickly becoming a hot name. This blog gives you an overview of DevOps & the container market."
}
</script>
